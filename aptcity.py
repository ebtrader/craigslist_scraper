...
url = 'https://'+city+'.craigslist.org/search/pen/apa'

#url = input('Enter Craigslist website address for apt listings: ')
#if len(url) < 1 : url = 'https://sfbay.craigslist.org/search/pen/apa'
#url = 'https://sfbay.craigslist.org/search/pen/apa?sort=priceasc&availabilityMode=0&postal={0}&search_distance={1}'
price = input('Enter a max price: ')
PRICE_MAX = int(price)
#PRICE_MAX = 400
